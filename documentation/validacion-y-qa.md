...
| Severity ranking | 100% (14/14) | > 95% | 14 hot-late (`HOT_PO_FLAG=1` y `delay_days_calc > 3`) |
...
El severity ranking es determinístico y auditable: lo produce una regla, no el LLM, de modo que
su resultado es reproducible por construcción.
...
- Suite de tests: 244 pasando. La suite creció con cada fase (de 57 a 99 a 114 a 244); el
  valor vigente es 244.
