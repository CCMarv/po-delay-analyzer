...
| [ADR-12](ARD-12.md) | Diseño del prompt de Fase 3: few-shot que enseña el razonamiento, con fuente única | 🔵 Borrador | Issue #99, #94 (benchmark), #91/#67, ADR-10, `llm_integration.py` (`build_prompt`) |
