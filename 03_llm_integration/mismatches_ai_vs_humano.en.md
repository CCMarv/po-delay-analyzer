...
| 100382 | Vendor | DC — "Yard congestion - no available door" | STA push 111.0 h (excess 87.0 h); yard/dock excess = 0 | Vendor, 5.01 d; the LLM marks a match and notes hot PO | Approval arrived late before the PO reached the yard; no measured excess in yard/dock |
